...
public class Prover {
    ...
    private static Clause parseClause(String line) {
        ...
        for (String literalStr : literalStrings) {
            ...
            if ((openParenIndex != -1 && closeParenIndex <= openParenIndex) || (openParenIndex == -1 && closeParenIndex != -1)) {
                throw new IllegalArgumentException("Invalid literal format: " + literalStr);
            }
            ...
            if (openParenIndex != -1 && closeParenIndex != -1) {
                ...
                for (String termStr : termStrings) {
                    ...
                    if (termStr.contains("(")) {
                        ...
                        throw new IllegalArgumentException("Empty term found in: " + termStr);
                    }
                }
            }
